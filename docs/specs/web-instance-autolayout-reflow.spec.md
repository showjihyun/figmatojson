...
- I-T3 master 의 `stackPrimaryAlignItems` 가 v1 지원 값 (`CENTER` 또는 undefined treated as default — Figma 의 기본값은 일반적으로 MIN). v1 에서는 **CENTER 만 처리**, 다른 값 (MIN/MAX/SPACE_BETWEEN/SPACE_EVENLY) 은 status quo.
